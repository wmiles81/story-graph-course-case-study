# Book 3 Act II — Step 25 Custody and Promise Reconstruction
...
- corrected custody records created: **{…}**
- stale custody records reviewed: **{…}**
- unsupported custody records rejected: **{…}**
...
- corrected promise lifecycle rows created: **{…}**
- stale late-batch promise IDs reviewed: **{…}**
- unsupported promise uses rejected: **{…}**
- descriptions superseded: **{…}**
- records routed to arc layer: **{…}**
